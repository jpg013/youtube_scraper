...
# def kafka_handler(KAFKA_BROKER, KAFKA_PORT, KAFKA_TOPIC, HOSTNAME, VERSION):
#     kh = KafkaHandler([KAFKA_BROKER + ':' + KAFKA_PORT], KAFKA_TOPIC)
...
#     logger = logging.getLogger(KAFKA_TOPIC)
